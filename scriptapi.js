...
// URL API
const apiUrl = 'https://crudcrud.com/api/28cd508cefb04b6da759d0a24b3e7ce8/products';
...
// Fungsi untuk menampilkan produk di dalam kartu
function renderProducts(products) {
    const box = document.querySelector('.box');
    // Kosongkan konten kartu sebelumnya
    box.innerHTML = '';
    // Loop melalui setiap produk dan buat elemen HTML untuk setiap produk
...
// Panggil fungsi fetchProducts dan renderProducts saat halaman dimuat
